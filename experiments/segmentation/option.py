...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--backbone-path', type=str, default='~/.encoding/models',
                            help='backbone-path')
        ...
        parser.add_argument('--multi-grid', action='store_true', default= False,
                            help='multi-grid')
        parser.add_argument('--num-center', type=int, default=256,
                            help='the amount of the codeword in CodeBook')
        ...
        parser.add_argument('--thres', type=float, default=0.9,
                            help='thres (default: 0.9)')
        parser.add_argument('--min-kept', type=int, default=131072,
                            help='min-kept (default: 131072)')
        ...
        parser.add_argument('--lateral', action='store_true', default= False,
                            help='feature maps aggregation (cat[layer3, layer4, layer5])')
        ...
        parser.add_argument('--local_rank', type=int, default=0,
                            metavar='N', help='local_rank (default:0)')
        parser.add_argument('--rank', type=int, default=0,
                            metavar='N', help='rank (default:0)')
        parser.add_argument('--world_size', type=int, default=0,
                            metavar='N', help='world_size (default:0)')
        # checking point
